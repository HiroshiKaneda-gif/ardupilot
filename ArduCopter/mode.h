...
public:
    ...
    enum class Number : uint8_t {
        ...
        ALT_HOLD_RUD_LESS = 98,  // manual airframe angle with automatic throttle and yaw angle
...
class ModeAltHoldRUDLESS : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::ALT_HOLD_RUD_LESS; }
...
protected:
    ...
    const char *name() const override { return "ALT_HOLD_RUD_LESS"; }
    const char *name4() const override { return "ALTR"; }
